...
RSpec.describe "Products", type: :request do
    ...
    describe "GET /products" do
        before(:all) do
            ...
            get products_path, headers: @auth_headers
    ...
    describe "POST /products" do
        context "valid product" do
            before(:all) do
                ...
                post products_path, params: { product: @product }, headers: @auth_headers
                @response_data = JSON.parse(response.body)
            end
    ...
    describe "PUT /products/:id" do
        context "valid product" do
            before(:all) do
                ...
                put product_path(@product), params: { product: @products_params}, headers: @auth_headers
                @response_data = JSON.parse(response.body)
            end
